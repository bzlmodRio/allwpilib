...
def fields_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = []):
    ...
    FIELDS_HEADER_GEN = [
        struct(
            ...
            header_root = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)",
            header_file = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)/wpi/fields/Field.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)",
            header_file = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)/wpi/fields/FieldImage.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)",
            header_file = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)/wpi/fields/FieldTag.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)",
            header_file = "$(execpath //fields/src/main/native:robotpy-native-fields.copy_headers)/wpi/fields/fields.hpp",
            tmpl_class_names = [],
            trampolines = [],
        ),
    ]
    ...
    gen_libinit(
        ...
        output_file = "robotpy_fields/_init__fields.py",
    ...
    gen_pkgconf(
        ...
        pkg_name = "fields",
        install_path = "robotpy_fields",
        project_file = "pyproject.toml",
        package_root = "robotpy_fields/__init__.py",
    )
    ...
    create_pybind_library(
        ...
        dynamic_deps = [
            "//fields/src/main/native:shared/fields",
...
def define_pybind_library(name, pkgcfgs = [], extra_pybind_hdrs = []):
    ...
    native.filegroup(
        ...
        srcs = native.glob(["robotpy_fields/**"], exclude = ["robotpy_fields/**/*.py"]),
        tags = ["manual", "robotpy"],
    )

    generate_version_file(
        name = "{}.generate_version".format(name),
        output_file = "robotpy_fields/version.py",
    ...
    robotpy_library(
        ...
        srcs = native.glob(["robotpy_fields/**/*.py"]) + [
            "robotpy_fields/_init__fields.py",
