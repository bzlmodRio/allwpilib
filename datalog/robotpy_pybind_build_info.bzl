...
def define_pybind_library(name, pkgcfgs = [], extra_pybind_hdrs = [], extra_pyi_deps = []):
    ...
    make_pyi(
        name = "wpilog._wpilog.make_pyi",
        package_name = "wpilog._wpilog",
        output_files = [["wpilog/_wpilog.pyi", "src/main/python/wpilog/_wpilog.pyi"]],
        module_files = [["wpilog", "src/main/python/wpilog/__init__.py"], ["wpilog._init__wpilog", "src/main/python/wpilog/_init__wpilog.py"], ["wpilog._wpilog", "src/main/python/wpilog/_wpilog"]],
