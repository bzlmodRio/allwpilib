...
def halsim_gui_ext_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = []):
    ...
    gen_pkgconf(
        ...
        install_path = "halsim_gui/_ext",
        project_file = "pyproject.toml",
        package_root = "halsim_gui/_ext/__init__.py",
    )
    ...
    run_header_gen(
        ...
        trampoline_subpath = "halsim_gui/_ext",
        ...
        local_native_libraries = [
            ...
            "//simulation/halsim_gui/src/main/native:robotpy-native-halsim-gui.copy_headers",
...
def define_pybind_library(name, pkgcfgs = []):
    ...
    native.filegroup(
        ...
        srcs = native.glob(["halsim_gui/**"], exclude = ["halsim_gui/**/*.py"]),
        tags = ["manual", "robotpy"],
    )

    generate_version_file(
        name = "{}.generate_version".format(name),
        output_file = "halsim_gui/version.py",
    ...
    robotpy_library(
        ...
        srcs = native.glob(["halsim_gui/**/*.py"]) + [
        ...
        deps = [
            ...
            "//simulation/halsim_gui/src/main/native:robotpy-native-halsim-gui",
