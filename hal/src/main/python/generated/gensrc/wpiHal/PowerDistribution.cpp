...
void finish() {
  ...
  cls_HAL_PowerDistributionVersion
    ...
    .def_readwrite("firmwareMajor", &::HAL_PowerDistributionVersion::firmwareMajor)
  
    .def_readwrite("firmwareMinor", &::HAL_PowerDistributionVersion::firmwareMinor)
  
    .def_readwrite("firmwareFix", &::HAL_PowerDistributionVersion::firmwareFix)
  
    .def_readwrite("hardwareMinor", &::HAL_PowerDistributionVersion::hardwareMinor)
  
    .def_readwrite("hardwareMajor", &::HAL_PowerDistributionVersion::hardwareMajor)
  
    .def_readwrite("uniqueId", &::HAL_PowerDistributionVersion::uniqueId)
  ;
