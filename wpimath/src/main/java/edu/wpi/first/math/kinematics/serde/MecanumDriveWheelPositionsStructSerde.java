...
public class MecanumDriveWheelPositionsStructSerde implements Struct<MecanumDriveWheelPositions> {
  @Override
  ...
  public String getSchema() {
    return "double front_left_meters;double front_right_meters;double rear_left_meters;double rear_right_meters";
  }
