...
def wpimath_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = []):
    ...
    WPIMATH_HEADER_GEN = [
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/util/ComputerVisionUtil.hpp",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/util/MathUtil.hpp",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/AntiTipping.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/ArmFeedforward.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/BangBangController.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/ControlAffinePlantInversionFeedforward.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/DifferentialDriveAccelerationLimiter.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/DifferentialDriveFeedforward.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/DifferentialDriveWheelVoltages.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/ElevatorFeedforward.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/ImplicitModelFollower.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/LTVDifferentialDriveController.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/LTVUnicycleController.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/LinearPlantInversionFeedforward.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/LinearQuadraticRegulator.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/PIDController.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/ProfiledPIDController.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/controller/SimpleMotorFeedforward.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/DifferentialDrivePoseEstimator.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/DifferentialDrivePoseEstimator3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/ExtendedKalmanFilter.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/KalmanFilter.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/MecanumDrivePoseEstimator.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/MecanumDrivePoseEstimator3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/PoseEstimator.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/PoseEstimator3d.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/SwerveDrivePoseEstimator.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/estimator/SwerveDrivePoseEstimator3d.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/filter/BiquadFilter.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/filter/Debouncer.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/filter/EdgeCounterFilter.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/filter/LinearFilter.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/filter/MedianFilter.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/filter/SlewRateLimiter.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/CoordinateAxis.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/CoordinateSystem.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Pose2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Pose3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Quaternion.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Rotation2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Rotation3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Transform2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Transform3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Translation2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Translation3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Twist2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/geometry/Twist3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/shape/Ellipse2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/shape/Rectangle2d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/interpolation/TimeInterpolatableBuffer.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/ChassisVelocities.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/ChassisAccelerations.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/DifferentialDriveKinematics.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/DifferentialDriveOdometry3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/DifferentialDriveOdometry.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/DifferentialDriveWheelPositions.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/DifferentialDriveWheelVelocities.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/DifferentialDriveWheelAccelerations.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/Kinematics.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/MecanumDriveKinematics.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/MecanumDriveOdometry.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/MecanumDriveOdometry3d.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/MecanumDriveWheelPositions.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/MecanumDriveWheelVelocities.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/MecanumDriveWheelAccelerations.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/Odometry.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/Odometry3d.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/SwerveDriveKinematics.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/SwerveDriveOdometry.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/SwerveDriveOdometry3d.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/SwerveModulePosition.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/SwerveModuleVelocity.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/kinematics/SwerveModuleAcceleration.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/optimization/SimulatedAnnealing.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/path/TravelingSalesman.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/spline/CubicHermiteSpline.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/spline/QuinticHermiteSpline.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/spline/Spline.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/spline/SplineHelper.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/spline/SplineParameterizer.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/system/DCMotor.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/system/LinearSystem.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/system/LinearSystemLoop.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/system/Models.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/system/NumericalIntegration.hpp",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/system/NumericalJacobian.hpp",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/DifferentialSample.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/DifferentialTrajectory.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/DrivetrainSplineSample.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/DrivetrainSplineTrajectory.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/DrivetrainSplineTrajectoryGenerator.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/DrivetrainSplineTrajectoryParameterizer.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/ExponentialProfile.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/HolonomicSample.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/HolonomicTrajectory.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/Trajectory.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/TrajectoryConfig.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/TrajectorySample.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/TrapezoidProfile.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/CentripetalAccelerationConstraint.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/DifferentialDriveKinematicsConstraint.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/DifferentialDriveVoltageConstraint.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/EllipticalRegionConstraint.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/MaxVelocityConstraint.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/MecanumDriveKinematicsConstraint.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/RectangularRegionConstraint.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/SwerveDriveKinematicsConstraint.hpp",
            tmpl_class_names = [
        ...
        struct(
            ...
            header_root = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)",
            header_file = "$(execpath //wpimath/src/main/native:robotpy-native-wpimath.copy_headers)/wpi/math/trajectory/constraint/TrajectoryConstraint.hpp",
            tmpl_class_names = [],
            trampolines = [
