...
":returns: The resulting chassis speed.")
  ...
  .
def
("getFrontLeftWheel", &frc::MecanumDriveKinematics::GetFrontLeftWheel, release_gil()
  )
  ...
  .
def
("getFrontRightWheel", &frc::MecanumDriveKinematics::GetFrontRightWheel, release_gil()
  )
  ...
  .
def
("getRearLeftWheel", &frc::MecanumDriveKinematics::GetRearLeftWheel, release_gil()
  )
  ...
  .
def
("getRearRightWheel", &frc::MecanumDriveKinematics::GetRearRightWheel, release_gil()
  )
