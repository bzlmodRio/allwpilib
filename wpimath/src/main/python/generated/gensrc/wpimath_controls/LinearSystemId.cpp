...
("elevatorSystem", &frc::LinearSystemId::ElevatorSystem,
      py::arg("motor"), py::arg("mass"), py::arg("radius"), py::arg("G"), release_gil(), py::doc(
...
("singleJointedArmSystem", &frc::LinearSystemId::SingleJointedArmSystem,
      py::arg("motor"), py::arg("J"), py::arg("G"), release_gil(), py::doc(
...
("drivetrainVelocitySystem", &frc::LinearSystemId::DrivetrainVelocitySystem,
      py::arg("motor"), py::arg("mass"), py::arg("r"), py::arg("rb"), py::arg("J"), py::arg("G"), release_gil(), py::doc(
