...
("neoVortex", &frc::DCMotor::NeoVortex,
    ...
    .def_readonly("nominalVoltage", &frc::DCMotor::nominalVoltage)
  
    .def_readonly("stallTorque", &frc::DCMotor::stallTorque)
  
    .def_readonly("stallCurrent", &frc::DCMotor::stallCurrent)
  
    .def_readonly("freeCurrent", &frc::DCMotor::freeCurrent)
  
    .def_readonly("freeSpeed", &frc::DCMotor::freeSpeed)
  
    .def_readonly("R", &frc::DCMotor::R)
  
    .def_readonly("Kv", &frc::DCMotor::Kv)
  
    .def_readonly("Kt", &frc::DCMotor::Kt)
  ;
