...
":returns: The minimum possible acceleration at the given velocity.")
    ...
    .def_readonly("kS", &frc::ElevatorFeedforward::kS)
  
    .def_readonly("kG", &frc::ElevatorFeedforward::kG)
  
    .def_readonly("kV", &frc::ElevatorFeedforward::kV)
  
    .def_readonly("kA", &frc::ElevatorFeedforward::kA)
  ;
