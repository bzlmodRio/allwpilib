...
":returns: The interpolated state.")
    ...
    .def_readwrite("t", &frc::Trajectory::State::t)
  
    .def_readwrite("velocity", &frc::Trajectory::State::velocity)
  
    .def_readwrite("acceleration", &frc::Trajectory::State::acceleration)
  
    .def_readwrite("pose", &frc::Trajectory::State::pose)
