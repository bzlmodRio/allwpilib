...
def _test_follow_trajectory(
    ...
    estimator.resetPosition(Rotation3d(), MecanumDriveWheelPositions(), Pose3d(starting_pose))
...
def test_simultaneous_vision_measurements():
    ...
    estimator.updateWithTime(0.0, Rotation3d(), MecanumDriveWheelPositions())
...
def test_discard_stale_vision_measurements():
    ...
    t = 0.0
    while t < 4.0:
        estimator.updateWithTime(t, Rotation3d(), MecanumDriveWheelPositions())
        t += 0.02
