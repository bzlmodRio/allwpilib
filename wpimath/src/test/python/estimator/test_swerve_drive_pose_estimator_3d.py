...
def _test_follow_trajectory(
    ...
    estimator.reset_position(Rotation3d(), positions, Pose3d(starting_pose))
    ...
    while t < trajectory.duration():
        ...
        module_velocities = kinematics.to_swerve_module_velocities(chassis_velocities)
...
def test_simultaneous_vision_measurements():
    ...
    estimator.update_with_time(0.0, Rotation3d(), _make_positions())
...
def test_discard_stale_vision_measurements():
    ...
    t = 0.0
    while t < 4.0:
        estimator.update_with_time(t, Rotation3d(), _make_positions())
        t += 0.02
