...
def _test_follow_trajectory(
    ...
    estimator.resetPosition(Rotation2d(), positions, starting_pose)
...
def test_simultaneous_vision_measurements():
    ...
    estimator.updateWithTime(0.0, Rotation2d(), _make_positions())
...
def test_discard_stale_vision_measurements():
    ...
    t = 0.0
    while t < 4.0:
        estimator.updateWithTime(t, Rotation2d(), _make_positions())
        t += 0.02
...
def test_sample_at():
    ...
    while time <= 2.0 + 1e-9:
        ...
        estimator.updateWithTime(time, Rotation2d(), positions)
        time += 0.02
...
def test_reset():
    ...
    estimator.resetPosition(
        Rotation2d(), pos1, Pose2d(x=1, y=0, rotation=Rotation2d())
    )
    ...
    estimator.update(Rotation2d(), pos2)
    ...
    estimator.update(Rotation2d(), pos3)
