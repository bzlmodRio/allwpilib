...
def _test_follow_trajectory(
    ...
    estimator.reset_position(Rotation2d(), positions, starting_pose)
...
def test_simultaneous_vision_measurements():
    ...
    estimator.update_with_time(0.0, Rotation2d(), _make_positions())
...
def test_discard_stale_vision_measurements():
    ...
    t = 0.0
    while t < 4.0:
        estimator.update_with_time(t, Rotation2d(), _make_positions())
        t += 0.02
