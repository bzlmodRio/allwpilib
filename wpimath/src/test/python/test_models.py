...
def test_flywheel_from_physical_constants():
    model = Models.flywheel_from_physical_constants(DCMotor.neo(2), 0.00032, 1.0)
...
def test_flywheel_from_sys_id():
    ...
    model = Models.flywheel_from_sys_id(kv, ka)
...
def test_differential_drive_from_physical_constants():
    model = Models.differential_drive_from_physical_constants(
...
def test_elevator_from_physical_constants():
    model = Models.elevator_from_physical_constants(DCMotor.neo(2), 5.0, 0.05, 12).slice(
        0
    )
...
def test_elevator_from_sys_id():
    ...
    model = Models.elevator_from_sys_id(kv, ka)
...
def test_single_jointed_arm_from_sys_id():
    ...
    model = Models.single_jointed_arm_from_sys_id(kv, ka)
