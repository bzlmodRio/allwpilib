...
def test_pose3d_log_x():
    end = Pose3d(x=0, y=5, z=5, rotation=Rotation3d.from_degrees(90, 0, 0))
    start = Pose3d()
...
def test_pose3d_log_y():
    end = Pose3d(x=5, y=0, z=5, rotation=Rotation3d.from_degrees(0, 90, 0))
    start = Pose3d()
...
def test_pose3d_log_z():
    end = Pose3d(x=5, y=5, z=0, rotation=Rotation3d.from_degrees(0, 0, 90))
    start = Pose3d()
