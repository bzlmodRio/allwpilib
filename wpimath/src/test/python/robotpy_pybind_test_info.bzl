...
def define_pybind_library(name, pkgcfgs = []):
    ...
    native.filegroup(
        ...
        srcs = native.glob(["cpp/wpimath_test/**"], exclude = ["cpp/wpimath_test/**/*.py"], allow_empty = True),
        tags = ["manual", "robotpy"],
    )
    ...
    robotpy_library(
        ...
        strip_path_prefixes = ["wpimath/src/test/python/cpp", "wpimath/src/test/python"],
    ...
    update_yaml_files(
        ...
        extra_hdrs = native.glob(["cpp/**/*.h"], allow_empty = True) + [
        ],
