...
def test_inverse_accelerations_for_zeros():
    ...
    wheel_accelerations = kinematics.to_wheel_accelerations(chassis_accelerations)
...
def test_forward_accelerations_for_zeros():
    ...
    chassis_accelerations = kinematics.to_chassis_accelerations(wheel_accelerations)
