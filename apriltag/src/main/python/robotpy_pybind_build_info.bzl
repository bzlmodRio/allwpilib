...
def apriltag_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = []):
    ...
    APRILTAG_HEADER_GEN = [
        struct(
            ...
            header_file = "$(execpath //apriltag:robotpy-native-apriltag.copy_headers)/wpi/apriltag/AprilTag.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //apriltag:robotpy-native-apriltag.copy_headers)",
            header_file = "$(execpath //apriltag:robotpy-native-apriltag.copy_headers)/wpi/apriltag/AprilTagFieldLayout.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //apriltag:robotpy-native-apriltag.copy_headers)",
            header_file = "$(execpath //apriltag:robotpy-native-apriltag.copy_headers)/wpi/apriltag/AprilTagFields.hpp",
            tmpl_class_names = [],
            trampolines = [],
        ),
        struct(
