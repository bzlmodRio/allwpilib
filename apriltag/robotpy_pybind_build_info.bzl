...
def _make_pyi_stubs(name, extra_pyi_deps = []):
    make_pyi(
        ...
        stub_files = [
            ...
            "$(location robotpy_apriltag/_apriltag.pyi)",
        ],
        remapping_args = [
            "robotpy_apriltag",
            "apriltag/src/main/python/robotpy_apriltag/__init__.py",
            "robotpy_apriltag._init__apriltag",
            "$(location :src/main/python/robotpy_apriltag/_init__apriltag.py)",
            "robotpy_apriltag._apriltag",
            "$(location :src/main/python/robotpy_apriltag/_apriltag)",
        ],
        outputs = [
            "robotpy_apriltag/_apriltag.pyi",
        ],
        srcs = [
            "src/main/python/robotpy_apriltag/__init__.py",
...
def define_pybind_library(name, pkgcfgs = [], create_pyi_extra_deps = [], create_imports_extra_deps = []):
    ...
    robotpy_library(
        ...
        strip_path_prefixes = ["robotpy_apriltag/src/main/python"],
