...
def drivers_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = []):
    ...
    DRIVERS_HEADER_GEN = [
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/odometry/GoBildaPinpoint.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/Koors40.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/PWMSparkFlex.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/PWMSparkMax.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/PWMTalonFX.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/PWMTalonSRX.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/PWMVenom.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/PWMVictorSPX.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/Spark.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/SparkMini.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/Talon.hpp",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)",
            header_file = "$(execpath //drivers/src/main/native:robotpy-native-wpilib-drivers.copy_headers)/wpi/drivers/motor/VictorSP.hpp",
            tmpl_class_names = [],
            trampolines = [
