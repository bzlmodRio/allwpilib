...
def define_pybind_library(name, pkgcfgs = []):
    ...
    robotpy_library(
        ...
        requires = ["robotpy-native-wpilib==0.0.0", "robotpy-wpiutil==0.0.0", "robotpy-wpimath==0.0.0", "robotpy-hal==0.0.0", "pyntcore==0.0.0", "robotpy-cli==0.0.0", "pytest>=3.9", "pytest-reraise"],
