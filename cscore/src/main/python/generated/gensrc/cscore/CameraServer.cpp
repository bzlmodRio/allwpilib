...
void finish() {
...

  {
    ...
    static constexpr auto kSize640x480 [[maybe_unused]] = frc::CameraServer::kSize640x480;
  
    static constexpr auto kSize320x240 [[maybe_unused]] = frc::CameraServer::kSize320x240;
  
    static constexpr auto kSize160x120 [[maybe_unused]] = frc::CameraServer::kSize160x120;
...
":param name: Camera name")
    ...
    .def_readonly_static("kBasePort", &frc::CameraServer::kBasePort)
  
    .def_readonly_static("kSize640x480", &frc::CameraServer::kSize640x480)
  
    .def_readonly_static("kSize320x240", &frc::CameraServer::kSize320x240)
  
    .def_readonly_static("kSize160x120", &frc::CameraServer::kSize160x120)
