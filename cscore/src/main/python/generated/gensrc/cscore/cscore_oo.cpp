...
void finish() {
  ...
  .
def
("getName", &cs::VideoProperty::GetName, release_gil()
  )
  ...
  .
def
("getKind", &cs::VideoProperty::GetKind, release_gil()
  )
  ...
  .
def
("isBoolean", &cs::VideoProperty::IsBoolean, release_gil()
  )
  ...
  .
def
("isInteger", &cs::VideoProperty::IsInteger, release_gil()
  )
  ...
  .
def
("isString", &cs::VideoProperty::IsString, release_gil()
  )
  ...
  .
def
("isEnum", &cs::VideoProperty::IsEnum, release_gil()
  )
  ...
  .
def
("get", &cs::VideoProperty::Get, release_gil()
  )
...
("set", &cs::VideoProperty::Set,
  ...
  .
def
("getMin", &cs::VideoProperty::GetMin, release_gil()
  )
  ...
  .
def
("getMax", &cs::VideoProperty::GetMax, release_gil()
  )
  ...
  .
def
("getStep", &cs::VideoProperty::GetStep, release_gil()
  )
  ...
  .
def
("getDefault", &cs::VideoProperty::GetDefault, release_gil()
  )
...
("getString", static_cast<std::string(cs::VideoProperty::*)() const>(
        &cs::VideoProperty::GetString), release_gil()
  )
...
("setString", &cs::VideoProperty::SetString,
  ...
  .
def
("getChoices", &cs::VideoProperty::GetChoices, release_gil()
  )
  ...
  .
def
("getLastStatus", &cs::VideoProperty::GetLastStatus, release_gil()
  )
...
":param choices:  Choices")
  ...
  .
def
("getHandle", &cs::VideoSink::GetHandle, release_gil()
  )
