...
def get_include_dirs():
    output = [join(_root, "src/main/native/include"), join(_root, "src/main/python/generated/rpy-include/wpilib._impl/rpy-include"), join(_root, "..", "..", "wpilibc", "src", "main", "native", "include")]
    import os
    for d in output:
