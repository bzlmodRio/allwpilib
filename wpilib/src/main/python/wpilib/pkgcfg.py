...
def get_include_dirs():
    output = [join(_root, "src/main/native/include"), join(_root, "src/main/python/generated/rpy-include/wpilib/rpy-include"), join(_root, "src"), join(_root, "..", "wpilibc", "src", "main", "native", "include"), join(_root, "..", "..", "..", "..", "..", "..", "..", "..", "..", "..", "git", "allwpilib", "wpilib", "src", "main", "python", "wpilib", "src")]
    import os
    for d in output:
