...
"Uses normalized voltage [-1.0..1.0].";
  ...
  cls_WheelSpeeds
    ...
    .def_readwrite("frontLeft", &frc::MecanumDrive::WheelSpeeds::frontLeft)
  
    .def_readwrite("frontRight", &frc::MecanumDrive::WheelSpeeds::frontRight)
  
    .def_readwrite("rearLeft", &frc::MecanumDrive::WheelSpeeds::rearLeft)
  
    .def_readwrite("rearRight", &frc::MecanumDrive::WheelSpeeds::rearRight)
  ;
