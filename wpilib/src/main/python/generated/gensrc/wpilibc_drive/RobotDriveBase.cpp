...
"1.0.")
    ...
    .def_readwrite("_m_deadband", &rpygen::PyTrampoline_frc__RobotDriveBase<typename frc::RobotDriveBase, typename rpygen::PyTrampolineCfg_frc__RobotDriveBase<>>::m_deadband)
    .def_readwrite("_m_maxOutput", &rpygen::PyTrampoline_frc__RobotDriveBase<typename frc::RobotDriveBase, typename rpygen::PyTrampolineCfg_frc__RobotDriveBase<>>::m_maxOutput);
