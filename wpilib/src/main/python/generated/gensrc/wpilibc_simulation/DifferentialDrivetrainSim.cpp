...
"5.95:1 -- 14:50 and 24:40";
  ...
  cls_KitbotGearing
    ...
    .def_readonly_static("k12p75", &frc::sim::DifferentialDrivetrainSim::KitbotGearing::k12p75)
  
    .def_readonly_static("k10p71", &frc::sim::DifferentialDrivetrainSim::KitbotGearing::k10p71)
  
    .def_readonly_static("k8p45", &frc::sim::DifferentialDrivetrainSim::KitbotGearing::k8p45)
  
    .def_readonly_static("k7p31", &frc::sim::DifferentialDrivetrainSim::KitbotGearing::k7p31)
  
    .def_readonly_static("k5p95", &frc::sim::DifferentialDrivetrainSim::KitbotGearing::k5p95)
  ;
  ...
  cls_KitbotMotor
    ...
    .def_readonly_static("SingleCIMPerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::SingleCIMPerSide)
  
    .def_readonly_static("DualCIMPerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::DualCIMPerSide)
  
    .def_readonly_static("SingleMiniCIMPerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::SingleMiniCIMPerSide)
  
    .def_readonly_static("DualMiniCIMPerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::DualMiniCIMPerSide)
  
    .def_readonly_static("SingleFalcon500PerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::SingleFalcon500PerSide)
  
    .def_readonly_static("DualFalcon500PerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::DualFalcon500PerSide)
  
    .def_readonly_static("SingleNEOPerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::SingleNEOPerSide)
  
    .def_readonly_static("DualNEOPerSide", &frc::sim::DifferentialDrivetrainSim::KitbotMotor::DualNEOPerSide)
  ;
  ...
  cls_KitbotWheelSize
    ...
    .def_readonly_static("kSixInch", &frc::sim::DifferentialDrivetrainSim::KitbotWheelSize::kSixInch)
  
    .def_readonly_static("kEightInch", &frc::sim::DifferentialDrivetrainSim::KitbotWheelSize::kEightInch)
  
    .def_readonly_static("kTenInch", &frc::sim::DifferentialDrivetrainSim::KitbotWheelSize::kTenInch)
  ;
