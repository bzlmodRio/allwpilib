...
("resetData", &frc::sim::PneumaticsBaseSim::ResetData, release_gil(), py::doc(
  ...
  .def(py::init_alias<const int>(),
    ...
    .def_readonly("_m_index", &rpygen::PyTrampoline_frc__sim__PneumaticsBaseSim<typename frc::sim::PneumaticsBaseSim, typename rpygen::PyTrampolineCfg_frc__sim__PneumaticsBaseSim<>>::m_index);
