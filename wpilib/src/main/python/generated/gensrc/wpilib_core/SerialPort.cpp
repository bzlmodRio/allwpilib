...
struct rpybuild_SerialPort_initializer {
  ...
  py::enum_<frc::SerialPort::Parity> cls_SerialPort_enum1;
    
    
  py::enum_<frc::SerialPort::StopBits> cls_SerialPort_enum2;
    
    
  py::enum_<frc::SerialPort::FlowControl> cls_SerialPort_enum3;
    
    
  py::enum_<frc::SerialPort::WriteBufferMode> cls_SerialPort_enum4;
    
    
  py::enum_<frc::SerialPort::Port> cls_SerialPort_enum5;
