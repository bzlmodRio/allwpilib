...
("getAccelZ", &frc::ADIS16448_IMU::GetAccelZ, release_gil(), py::doc(
  ...
  .
def
("getXComplementaryAngle", &frc::ADIS16448_IMU::GetXComplementaryAngle, release_gil()
  )
  ...
  .
def
("getYComplementaryAngle", &frc::ADIS16448_IMU::GetYComplementaryAngle, release_gil()
  )
  ...
  .
def
("getXFilteredAccelAngle", &frc::ADIS16448_IMU::GetXFilteredAccelAngle, release_gil()
  )
  ...
  .
def
("getYFilteredAccelAngle", &frc::ADIS16448_IMU::GetYFilteredAccelAngle, release_gil()
  )
  ...
  .
def
("getMagneticFieldX", &frc::ADIS16448_IMU::GetMagneticFieldX, release_gil()
  )
  ...
  .
def
("getMagneticFieldY", &frc::ADIS16448_IMU::GetMagneticFieldY, release_gil()
  )
  ...
  .
def
("getMagneticFieldZ", &frc::ADIS16448_IMU::GetMagneticFieldZ, release_gil()
  )
  ...
  .
def
("getBarometricPressure", &frc::ADIS16448_IMU::GetBarometricPressure, release_gil()
  )
  ...
  .
def
("getTemperature", &frc::ADIS16448_IMU::GetTemperature, release_gil()
  )
...
("setYawAxis", &frc::ADIS16448_IMU::SetYawAxis,
  ...
  .
def
("isConnected", &frc::ADIS16448_IMU::IsConnected, release_gil()
  )
...
("configDecRate", &frc::ADIS16448_IMU::ConfigDecRate,
      py::arg("DecimationRate"), release_gil()
  )
