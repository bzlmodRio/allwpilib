...
("getVersion", &frc::PowerDistribution::GetVersion, release_gil()
  ...
  .
def
("getFaults", &frc::PowerDistribution::GetFaults, release_gil()
  )
  ...
  .
def
("getStickyFaults", &frc::PowerDistribution::GetStickyFaults, release_gil()
  )
...
("initSendable", &frc::PowerDistribution::InitSendable,
    ...
    .def_readonly_static("kDefaultModule", &frc::PowerDistribution::kDefaultModule)
  ;
