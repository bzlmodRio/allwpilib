...
("initSendable", &frc::Counter::InitSendable,
    ...
    .def_readonly("_m_upSource", &rpygen::PyTrampoline_frc__Counter<typename frc::Counter, typename rpygen::PyTrampolineCfg_frc__Counter<>>::m_upSource)
    .def_readonly("_m_downSource", &rpygen::PyTrampoline_frc__Counter<typename frc::Counter, typename rpygen::PyTrampolineCfg_frc__Counter<>>::m_downSource);
