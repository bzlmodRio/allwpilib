...
("initSendable", &frc::ADXL345_SPI::InitSendable,
    ...
    .def_readonly("_m_simDevice", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::m_simDevice)
    .def_readonly("_m_simRange", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::m_simRange)
    .def_readonly("_m_simX", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::m_simX)
    .def_readonly("_m_simY", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::m_simY)
    .def_readonly("_m_simZ", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::m_simZ)
    .def_readonly_static("_kPowerCtlRegister", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::kPowerCtlRegister)
    .def_readonly_static("_kDataFormatRegister", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::kDataFormatRegister)
    .def_readonly_static("_kDataRegister", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::kDataRegister)
    .def_readonly_static("_kGsPerLSB", &rpygen::PyTrampoline_frc__ADXL345_SPI<typename frc::ADXL345_SPI, typename rpygen::PyTrampolineCfg_frc__ADXL345_SPI<>>::kGsPerLSB);
  ...
  cls_AllAxes
    ...
    .def_readwrite("XAxis", &frc::ADXL345_SPI::AllAxes::XAxis)
  
    .def_readwrite("YAxis", &frc::ADXL345_SPI::AllAxes::YAxis)
  
    .def_readwrite("ZAxis", &frc::ADXL345_SPI::AllAxes::ZAxis)
  ;
