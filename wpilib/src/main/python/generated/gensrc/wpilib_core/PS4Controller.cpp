...
"          attached to the given loop.")
  ...
  cls_Button
    ...
    .def_readonly_static("kSquare", &frc::PS4Controller::Button::kSquare)
  
    .def_readonly_static("kCross", &frc::PS4Controller::Button::kCross)
  
    .def_readonly_static("kCircle", &frc::PS4Controller::Button::kCircle)
  
    .def_readonly_static("kTriangle", &frc::PS4Controller::Button::kTriangle)
  
    .def_readonly_static("kL1", &frc::PS4Controller::Button::kL1)
  
    .def_readonly_static("kR1", &frc::PS4Controller::Button::kR1)
  
    .def_readonly_static("kL2", &frc::PS4Controller::Button::kL2)
  
    .def_readonly_static("kR2", &frc::PS4Controller::Button::kR2)
  
    .def_readonly_static("kShare", &frc::PS4Controller::Button::kShare)
  
    .def_readonly_static("kOptions", &frc::PS4Controller::Button::kOptions)
  
    .def_readonly_static("kL3", &frc::PS4Controller::Button::kL3)
  
    .def_readonly_static("kR3", &frc::PS4Controller::Button::kR3)
  
    .def_readonly_static("kPS", &frc::PS4Controller::Button::kPS)
  
    .def_readonly_static("kTouchpad", &frc::PS4Controller::Button::kTouchpad)
  ;
  ...
  cls_Axis
    ...
    .def_readonly_static("kLeftX", &frc::PS4Controller::Axis::kLeftX)
  
    .def_readonly_static("kLeftY", &frc::PS4Controller::Axis::kLeftY)
  
    .def_readonly_static("kRightX", &frc::PS4Controller::Axis::kRightX)
  
    .def_readonly_static("kRightY", &frc::PS4Controller::Axis::kRightY)
  
    .def_readonly_static("kL2", &frc::PS4Controller::Axis::kL2)
  
    .def_readonly_static("kR2", &frc::PS4Controller::Axis::kR2)
  ;
