...
"WPILib Known Issues</a> page for details.";
  ...
  .def(py::init<I2C::Port, Range, int>(),
      py::arg("port"), py::arg("range") = kRange_2G, py::arg("deviceAddress") = ADXL345_I2C_Trampoline::kAddress, release_gil(), py::doc(
...
("initSendable", &frc::ADXL345_I2C::InitSendable,
    ...
    .def_readonly("_m_simDevice", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::m_simDevice)
    .def_readonly("_m_simRange", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::m_simRange)
    .def_readonly("_m_simX", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::m_simX)
    .def_readonly("_m_simY", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::m_simY)
    .def_readonly("_m_simZ", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::m_simZ)
    .def_readonly_static("_kAddress", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::kAddress)
    .def_readonly_static("_kPowerCtlRegister", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::kPowerCtlRegister)
    .def_readonly_static("_kDataFormatRegister", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::kDataFormatRegister)
    .def_readonly_static("_kDataRegister", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::kDataRegister)
    .def_readonly_static("_kGsPerLSB", &rpygen::PyTrampoline_frc__ADXL345_I2C<typename frc::ADXL345_I2C, typename rpygen::PyTrampolineCfg_frc__ADXL345_I2C<>>::kGsPerLSB);
  ...
  cls_AllAxes
    ...
    .def_readwrite("XAxis", &frc::ADXL345_I2C::AllAxes::XAxis)
  
    .def_readwrite("YAxis", &frc::ADXL345_I2C::AllAxes::YAxis)
  
    .def_readwrite("ZAxis", &frc::ADXL345_I2C::AllAxes::ZAxis)
  ;
