...
def define_pybind_library(name, pkgcfgs = [], extra_pybind_hdrs = [], extra_pyi_deps = []):
    ...
    make_pyi(
        name = "xrp._xrp.make_pyi",
        package_name = "xrp._xrp",
        output_files = [["xrp/_xrp.pyi", "src/main/python/xrp/_xrp.pyi"]],
        module_files = [["xrp", "src/main/python/xrp/__init__.py"], ["xrp._init__xrp", "src/main/python/xrp/_init__xrp.py"], ["xrp._xrp", "src/main/python/xrp/_xrp"]],
