...
def xrp_extension(srcs = [], header_to_dat_deps = [], extra_hdrs = [], includes = [], extra_pyi_deps = []):
    XRP_HEADER_GEN = [
        struct(
            ...
            header_file = "$(execpath :robotpy-native-xrp.copy_headers)/frc/xrp/XRPGyro.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-xrp.copy_headers)",
            header_file = "$(execpath :robotpy-native-xrp.copy_headers)/frc/xrp/XRPMotor.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-xrp.copy_headers)",
            header_file = "$(execpath :robotpy-native-xrp.copy_headers)/frc/xrp/XRPOnBoardIO.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-xrp.copy_headers)",
            header_file = "$(execpath :robotpy-native-xrp.copy_headers)/frc/xrp/XRPRangefinder.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-xrp.copy_headers)",
            header_file = "$(execpath :robotpy-native-xrp.copy_headers)/frc/xrp/XRPReflectanceSensor.h",
            tmpl_class_names = [],
            trampolines = [
        ...
        struct(
            ...
            header_root = "$(execpath :robotpy-native-xrp.copy_headers)",
            header_file = "$(execpath :robotpy-native-xrp.copy_headers)/frc/xrp/XRPServo.h",
            tmpl_class_names = [],
            trampolines = [
...
def define_pybind_library(name, pkgcfgs=[]):
    ...
    robotpy_library(
        ...
        requires = ["robotpy-native-xrp==2027.0.0a2", "wpilib==2027.0.0a2"],
        entry_points = {
            "pkg_config": ["xrp = xrp"],
        },
        visibility = ["//visibility:public"],
    ...
    create_imports(
        ...
        # project_file = "xrpVendordep/src/main/python/pyproject.toml",
        library = [name],
        update_init = ["xrp"],
    )
